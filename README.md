...
| GRIST_WIDGET_LIST_URL | a url pointing to a widget manifest, by default https://github.com/gristlabs/grist-widget/releases/download/latest/manifest.json is used. Supports multiple URLs separated by commas to combine widget sources from different repositories. |
